      ...
      >
        ...
        <template v-if="showControls && items.length > 1">
          <a
            ...
            ><span style="position:relative;top:50%; left: 20px"
              ><img src="../assets/slider-left.svg" alt="" width="42" height="42"></span
            ></a
          >
          <a
            @click="showNextImage"
            ...
            ><span style="position:relative;top:50%; right: 20px"
              ><img src="../assets/slider-right-icon.svg" alt="" width="42" height="42"></span
            ></a
          >
          <a
